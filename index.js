...
async function main() {
    ...
    while (!halt) {
        ...
        switch (opcode) {
            ...
            case 0x09: break; // ret Return from function
            ...
            case 0x15: break; // bzc PC+N Branch if zero clear (Branch if not equal)
